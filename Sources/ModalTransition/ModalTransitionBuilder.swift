@resultBuilder
public enum ModalTransitionBuilder {
    #if compiler(>=5.7)
    public static func buildPartialBlock<T1: ModalTransition>(first: T1) -> T1 {
        first
    }

    public static func buildPartialBlock<T1: ModalTransition, T2: ModalTransition>(accumulated: T1, next: T2) -> Combined<T1, T2> {
    ...
    public static func buildOptional<T: ModalTransition>(_ component: T?) -> _OptionalTransition<T> {
    ...
    public static func buildEither<TrueTransition: ModalTransition, FalseTransition: ModalTransition>(first component: TrueTransition) -> _ConditionalTransition<TrueTransition, FalseTransition> {
        _ConditionalTransition(trueTransition: component)
    }

    public static func buildEither<TrueTransition: ModalTransition, FalseTransition: ModalTransition>(second component: FalseTransition) -> _ConditionalTransition<TrueTransition, FalseTransition> {
        _ConditionalTransition(falseTransition: component)
    }
}

public struct _OptionalTransition<Transition: ModalTransition>: ModalTransition {
...
public struct _ConditionalTransition<TrueTransition: ModalTransition, FalseTransition: ModalTransition>: ModalTransition {
