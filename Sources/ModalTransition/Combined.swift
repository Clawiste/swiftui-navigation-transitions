extension AnyModalTransition {
    ...
    public func combined(with other: Self) -> Self {
        ...
        case (.transient(let lhsHandler), .transient(let rhsHandler)):
            struct Erased: ModalTransition {
                let handler: AnyModalTransition.TransientHandler
...
public struct Combined<TransitionA: ModalTransition, TransitionB: ModalTransition>: ModalTransition {
    ...
    public init(@ModalTransitionBuilder transitions: () -> Self) {
        self = transitions()
    }
